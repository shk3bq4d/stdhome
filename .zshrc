...
alias -g T='|tail'
alias -g TT='2>&1|tail'
alias -g G='|grep -a --color=always -E'
alias -g GI='|grep -i -a --color=always -E'
alias -g GG='2>&1|grep -a --color=always -E'
alias -g GGI='2>&1|grep -i -a --color=always -E'
alias -g V='2>&1|vim -'
alias -g V1='|vim -'
#alias -g V2='>/dev/null 2>&1|vim -'
alias -g V2='2>&1 1>/dev/null|vim -' # doesn't work yet, don't know why, before | vim - looks correct
alias -g C='2>&1|cat -'
alias -g N1='>/dev/null'
